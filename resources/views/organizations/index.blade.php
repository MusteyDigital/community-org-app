            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                @forelse($organizations as $organization)
                    <div class="bg-white rounded-xl border border-sand-200 p-6">
                        ...
                        <form method="POST" action="{{ route('organizations.join', $organization) }}" class="mt-4 space-y-2">
                            @csrf
                            <input type="text" name="phone" placeholder="Your phone number (optional)" class="w-full text-sm border-sand-200 rounded-md focus:border-teal-700 focus:ring-teal-700">
